    ...
    <div class="p-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          {!! Form::select('department_id', ['' => 'Chọn phòng ban'] + $departments, $user->department_id, ['class' => 'mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500']) !!}
