...
<div class="max-w-5xl mx-auto sm:px-6 lg:px-8 py-6">
  <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
    <div class="p-6 border-b border-gray-200 flex items-center justify-between">
      <h2 class="text-lg font-semibold text-black-900">Chỉnh sửa người dùng</h2>
    ...
    <div class="p-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="md:col-span-2">
          ...
          {!! Form::select('roles[]', $roles,$userRole, ['class' => 'mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500','multiple']) !!}
          <p class="text-red-600 text-sm mt-1">{{ $errors->first('roles') }}</p>
        </div>
      </div>
      <div class="mt-6 text-right">
        <button type="submit" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-black rounded-md">Xác nhận</button>
      </div>
      {!! Form::close() !!}
    </div>
  </div>
