        ...
        <div class="p-6 border-b border-gray-200 flex items-center justify-between">
            ...
            <div class="flex items-center space-x-2">
                ...
                <a href="{{ $fileInfo['download_url'] }}" 
                   class="inline-flex items-center px-4 py-2 bg-green-600 hover:bg-green-700 rounded-md" style="text-color: black;"
            ...
            <div class="border border-gray-200 rounded-lg overflow-hidden">
                <div class="bg-gray-50 px-4 py-2 border-b border-gray-200">
                    <div class="flex items-center text-sm text-gray-600">
                        ...
                        <span>Đang hiển thị bằng Google Docs Viewer - Phông chữ tiếng Việt sẽ được hiển thị chính xác</span>
                    </div>
                </div>
                
                <iframe src="{{ $fileInfo['google_docs_url'] }}" 
                        class="w-full h-screen min-h-[600px]"
                        frameborder="0">
                    <p>Trình duyệt của bạn không hỗ trợ iframe. 
                       <a href="{{ $fileInfo['google_docs_url'] }}" target="_blank">Nhấn vào đây để xem</a>
                    </p>
                </iframe>
            </div>
                ...
                <div class="flex items-start">
                    ...
                    <div class="text-sm text-blue-800">
                        ...
                        <ul class="list-disc list-inside space-y-1">
                            <li>File được hiển thị bằng Google Docs Viewer để đảm bảo phông chữ tiếng Việt hiển thị chính xác</li>
                            <li>Nếu file không hiển thị, có thể do kết nối internet hoặc file quá lớn</li>
                            <li>Bạn vẫn có thể tải về file gốc để xem offline</li>
                        </ul>
                    </div>
                </div>
            </div>
