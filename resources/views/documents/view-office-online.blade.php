        ...
        <div class="p-6 border-b border-gray-200 flex items-center justify-between">
            ...
            <div class="flex items-center space-x-2">
                <span class="inline-flex items-center px-2 py-1 text-xs font-medium rounded-full bg-blue-100 text-blue-800">
                    <i class="fas fa-microsoft mr-1"></i>
            ...
            <div class="border border-gray-200 rounded-lg overflow-hidden">
                <div class="bg-gray-50 px-4 py-2 border-b border-gray-200">
                    <div class="flex items-center text-sm text-gray-600">
                        ...
                        <span>Đang hiển thị bằng Microsoft Office Online - Phông chữ tiếng Việt sẽ được hiển thị chính xác</span>
                    </div>
                </div>
                
                <iframe src="{{ $fileInfo['office_online_url'] }}" 
                        class="w-full h-screen min-h-[600px]"
                        frameborder="0">
                    <p>Trình duyệt của bạn không hỗ trợ iframe. 
                       <a href="{{ $fileInfo['office_online_url'] }}" target="_blank">Nhấn vào đây để xem</a>
                    </p>
                </iframe>
            </div>
                ...
                <div class="flex items-start">
                    ...
                    <div class="text-sm text-blue-800">
                        ...
                        <ul class="list-disc list-inside space-y-1">
                            <li>File được hiển thị bằng Microsoft Office Online để đảm bảo phông chữ tiếng Việt hiển thị chính xác</li>
