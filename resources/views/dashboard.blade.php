            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <div class="text-sm font-medium text-gray-500">Chờ xử lý</div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <div class="text-sm font-medium text-gray-500">Hoàn thành</div>
                                    ...
                                    @switch($registration->status)
                                        @case('pending')
                                            ...
                                            @case('received')
                                                ...
                                                @break
                                            @case('processing')
                                                <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full bg-indigo-100 text-indigo-800">Đang xử lý</span>
                                                @break
                                            @case('completed')
