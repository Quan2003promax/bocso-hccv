    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        ...
        <div class="p-6 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-lg font-semibold text-gray-900">Sửa vai trò</h2>
                    <p class="text-sm text-gray-600 mt-1">Cập nhật thông tin vai trò: {{ $role->name }}</p>
                </div>
                <div>
                    <a class="inline-flex items-center px-4 py-2 bg-gray-600 hover:bg-gray-700 text-black rounded-md transition duration-150 ease-in-out" href="{{ route('roles.index') }}">
        ...
        <form method="POST" action="{{ route('roles.update', $role->id) }}">
            ...
            <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex items-center justify-between">
                ...
                <div class="text-sm text-gray-500">
                    ...
                    Vai trò sẽ được cập nhật ngay lập tức
                </div>
            </div>
        </form>
    </div>
